...
Shader "Custom/RippleWater" {
  ...
  [HideInInspector]_WaveAmplitude9 ("WaveAmplitude1", float) = 0
  ...
  [HideInInspector]_zImpact8 ("z Impact 8", float) = 0
    [HideInInspector]_xImpact9 ("x Impact 9", float) = 0
  [HideInInspector]_zImpact9 ("z Impact 9", float) = 0
  ...
  [HideInInspector]_Distance9 ("Distance9", float) = 0
	...
	SubShader {
		...
		half4 _Color;
		float _WaveAmplitude1, _WaveAmplitude2, _WaveAmplitude3, _WaveAmplitude4, _WaveAmplitude5, _WaveAmplitude6, _WaveAmplitude7, _WaveAmplitude8,_WaveAmplitude9;
		float _OffsetX1, _OffsetZ1, _OffsetX2, _OffsetZ2, _OffsetX3, _OffsetZ3,_OffsetX4, _OffsetZ4,_OffsetX5, _OffsetZ5,_OffsetX6, _OffsetZ6,_OffsetX7, _OffsetZ7,_OffsetX8, _OffsetZ8,_OffsetX9, _OffsetZ9;
		float _Distance1, _Distance2 , _Distance3, _Distance4, _Distance5, _Distance6, _Distance7, _Distance8,_Distance9;
		...
		_xImpact7, _zImpact7,_xImpact8, _zImpact8,_xImpact9, _zImpact9;
		...
		half value9 = _Scale * sin(_Time.w * _Speed * _Frequency + offsetvert + (v.vertex.x * _OffsetX9) + (v.vertex.z * _OffsetZ9)  );
		...
		if (sqrt(pow(worldPos.x - _xImpact9, 2) + pow(worldPos.z - _zImpact9, 2)) < _Distance9)
		{
		v.vertex.y += value9 * _WaveAmplitude9;
		v.normal.y += value9 * _WaveAmplitude9;
		o.customValue += value9 * _WaveAmplitude9;
		}
